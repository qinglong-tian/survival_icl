...
class SCMPrior(Prior):
    ...
    def get_batch(self, batch_size: Optional[int] = None) -> Tuple[Tensor, Tensor, Tensor, Tensor, Tensor]:
        ...
        # Uses threading backend to avoid fork() deadlocks on macOS.
        # Generate prior datasets separately from training and load from disk to
        # avoid on-the-fly generation during DDP training.
