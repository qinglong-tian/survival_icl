...
# ==========================================================================
# 2-GPU H100 medium smoke test (~1.5 hr) — 300-step stability validation.
#
# Gates (beyond basic DDP/no-crash):
#   1. step-100.ckpt, step-200.ckpt, step-300.ckpt exist
...
echo "============================================"
echo "Survival Pretraining Medium Smoke Test"
...
# ---- directories -------------------------------------------------------
RUN_DIR="/scratch/${USER}/survival-medium-${SLURM_JOB_ID}"
...
echo ""
echo "============================================"
echo "Training: ${NPROC} GPUs, 300 steps"
