...
# Uses model_type=mix with broad baseline priors, log-uniform effect sizes,
# and log-uniform time scales for maximum event-time diversity.

# Common diversity flags
DIVERSITY_FLAGS="--model_type mix --beta_sampling log_uniform --min_beta 0.25 --max_beta 2.0 --baseline_param_prior broad --time_scale_sampling log_uniform --min_time_scale 0.2 --max_time_scale 5.0"
